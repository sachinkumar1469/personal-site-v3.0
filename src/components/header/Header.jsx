            ...
            <nav className="nav container">
                ...
                <div className="nav__menu" ref={menuRef}>
                    <ul className="nav__list grid">
                        ...
                        <li className="nav__item " onClick={closeMenu}>
                            <a href="#qualification" className="nav__link qualification">
                        ...
                        <li className="nav__item " onClick={closeMenu}>
                            <a href="#projects" className="nav__link projects">
                ...
                <div className="nav__btns">
                    <IoMoonOutline className='change-theme' onClick={toggleTheme} id='theme-button'/>
